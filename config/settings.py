...
class Settings(BaseSettings):
    ...
    slack_report_channel_id: Optional[str] = Field(None, description="Channel for reports")
    ...
    notion_report_page_id: Optional[str] = Field(None, description="Notion Page ID for reports")
